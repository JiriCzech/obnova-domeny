(function() {
  ...
  navigator.clipboard.readText().then(txt => {
    ...
    let instrukceText = "";
    if (privacy === "true") {
      instrukceText = "Ahoj, prosím o obnovu domény " + domain + " o 2 roky včetně skryté registrace. Díky";
    } else {
      instrukceText = "Ahoj, prosím o obnovu domény " + domain + " o 2 roky. Díky";
    }
